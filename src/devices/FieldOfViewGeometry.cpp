...
{ 
  debug("field size(um): %f"ENDL,(lhs.field_size_um_    - rhs.field_size_um_   ).norm());
  debug("overlap   (um): %f"ENDL,(lhs.overlap_um_       - rhs.overlap_um_      ).norm());
  debug("rotation (rad): %f"ENDL,fabs(lhs.rotation_radians_ - rhs.rotation_radians_));
