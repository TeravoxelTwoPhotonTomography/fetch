    ...
    MicroscopeStateMenu::__tasktable[] =
      {
        ...
        { "&Scan Stack",  -1, new task::microscope::StackAcquisition },
        { NULL, NULL, NULL }, };
		...
		{ _task_table = this->__tasktable;
		  ...
		  DEFINE_USER_MESSAGE_INT__NON_STATIC( IDM_MICROSCOPE_TASK_1, _instance_id);
		  _task_table[0].messageid = IDM_MICROSCOPE_TASK_0;
		  _task_table[1].messageid = IDM_MICROSCOPE_TASK_1;
		}
