...
#define DIGWRN( expression )  (niscope_chk( g_digitizer.vi, expression, #expression, &warning ))
#define DIGERR( expression )  (niscope_chk( g_digitizer.vi, expression, #expression, &error   ))

typedef ViInt16 TPixel;

Scanner               g_scanenr                = SCANNER_DEFAULT; //XXX HERE
