    ...
    { f32 *src_cur = buf + nelem,
      ...
      { acc_cur = acc + nele,;
        ...
        goto_if_fail(                    //   push - wait till successful
          Asynq_Push_Timed( qdst, (void**)&acc, AVERAGER_DEFAULT_TIMEOUT ),
...
#define _CASTER_LOOP(TI,T0) \
  TI   *src = (TI*) Asynq_Token_Buffer_Alloc(qsrc),\
  TO   *dst = (TO*) Asynq_Token_Buffer_Alloc(qdst);\
  do\
  { while( Asynq_Pop(qsrc, &buf) )\
    { TI *src_cur = src + nelem;\
      TO *dst_cur = acc + nelem;\
      while( src_cur >= src )\
        *(--acc_cur) = (TO) *(--src_cur);\
      goto_if_fail(\
        Asynq_Push_Timed( qdst, (void**)&acc, AVERAGER_DEFAULT_TIMEOUT ),\
...
{ struct _averager_context *ctx = (struct _averager_context*) d->context;
  ...
  { case id_u8:
    { switch( ctx->dest_type )
      { case id_u8:               _CASTER_LOOP(u8 ,u8 ); break;
        case id_u16:              _CASTER_LOOP(u8 ,u16); break;
        case id_u32:              _CASTER_LOOP(u8 ,u32); break;
        case id_u64:              _CASTER_LOOP(u8 ,u64); break;
        case id_i8:               _CASTER_LOOP(u8 ,i8 ); break;
        case id_i16:              _CASTER_LOOP(u8 ,i16); break;
        case id_i32:              _CASTER_LOOP(u8 ,i32); break;
        case id_i64:              _CASTER_LOOP(u8 ,i64); break;
        case id_f32:              _CASTER_LOOP(u8 ,f32); break;
        case id_f64:              _CASTER_LOOP(u8 ,f64); break;
        default:
    ...
    case id_u16:
    { switch( ctx->dest_type )
      { case id_u8:               _CASTER_LOOP(u16,u8 ); break;
        case id_u16:              _CASTER_LOOP(u16,u16); break;
        case id_u32:              _CASTER_LOOP(u16,u32); break;
        case id_u64:              _CASTER_LOOP(u16,u64); break;
        case id_i8:               _CASTER_LOOP(u16,i8 ); break;
        case id_i16:              _CASTER_LOOP(u16,i16); break;
        case id_i32:              _CASTER_LOOP(u16,i32); break;
        case id_i64:              _CASTER_LOOP(u16,i64); break;
        case id_f32:              _CASTER_LOOP(u16,f32); break;
        case id_f64:              _CASTER_LOOP(u16,f64); break;
        default:
          goto UnknownTypeError;
      }
      break;
    ...
    case id_u32:
    { switch( ctx->dest_type )
      { case id_u8:               _CASTER_LOOP(u32,u8 ); break;
        case id_u16:              _CASTER_LOOP(u32,u16); break;
        case id_u32:              _CASTER_LOOP(u32,u32); break;
        case id_u64:              _CASTER_LOOP(u32,u64); break;
        case id_i8:               _CASTER_LOOP(u32,i8 ); break;
        case id_i16:              _CASTER_LOOP(u32,i16); break;
        case id_i32:              _CASTER_LOOP(u32,i32); break;
        case id_i64:              _CASTER_LOOP(u32,i64); break;
        case id_f32:              _CASTER_LOOP(u32,f32); break;
        case id_f64:              _CASTER_LOOP(u32,f64); break;
        default:
          goto UnknownTypeError;
      }
      break;
    ...
    case id_u64:
    { switch( ctx->dest_type )
      { case id_u8:               _CASTER_LOOP(u64,u8 ); break;
        case id_u16:              _CASTER_LOOP(u64,u16); break;
        case id_u32:              _CASTER_LOOP(u64,u32); break;
        case id_u64:              _CASTER_LOOP(u64,u64); break;
        case id_i8:               _CASTER_LOOP(u64,i8 ); break;
        case id_i16:              _CASTER_LOOP(u64,i16); break;
        case id_i32:              _CASTER_LOOP(u64,i32); break;
        case id_i64:              _CASTER_LOOP(u64,i64); break;
        case id_f32:              _CASTER_LOOP(u64,f32); break;
        case id_f64:              _CASTER_LOOP(u64,f64); break;
        default:
          goto UnknownTypeError;
      }
      break;
    ...
    case id_i8:
    { switch( ctx->dest_type )
      { case id_u8:               _CASTER_LOOP(i8 ,u8 ); break;
        case id_u16:              _CASTER_LOOP(i8 ,u16); break;
        case id_u32:              _CASTER_LOOP(i8 ,u32); break;
        case id_u64:              _CASTER_LOOP(i8 ,u64); break;
        case id_i8:               _CASTER_LOOP(i8 ,i8 ); break;
        case id_i16:              _CASTER_LOOP(i8 ,i16); break;
        case id_i32:              _CASTER_LOOP(i8 ,i32); break;
        case id_i64:              _CASTER_LOOP(i8 ,i64); break;
        case id_f32:              _CASTER_LOOP(i8 ,f32); break;
        case id_f64:              _CASTER_LOOP(i8 ,f64); break;
        default:
          goto UnknownTypeError;
      }
      break;
    ...
    case id_i16:
    { switch( ctx->dest_type )
      { case id_u8:               _CASTER_LOOP(i16,u8 ); break;
        case id_u16:              _CASTER_LOOP(i16,u16); break;
        case id_u32:              _CASTER_LOOP(i16,u32); break;
        case id_u64:              _CASTER_LOOP(i16,u64); break;
        case id_i8:               _CASTER_LOOP(i16,i8 ); break;
        case id_i16:              _CASTER_LOOP(i16,i16); break;
        case id_i32:              _CASTER_LOOP(i16,i32); break;
        case id_i64:              _CASTER_LOOP(i16,i64); break;
        case id_f32:              _CASTER_LOOP(i16,f32); break;
        case id_f64:              _CASTER_LOOP(i16,f64); break;
        default:
          goto UnknownTypeError;
      }
      break;
...
{ // 1. setup context
  struct _caster_context *ctx = Guarded_Malloc( sizeof(struct _caster_context), "Worker_Create_Task_Averager" );
  ctx->source_type = source_type;
  ctx->dest_type = dest_type;
  source->context = (void*) ctx;
  
  // 2. make task
  return DeviceTask_Alloc(_Caster_f32_Cfg,
                          _Caster_f32_Proc);
}
