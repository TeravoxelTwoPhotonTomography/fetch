        ...
        static public bool ConfigureBoard(IntPtr boardHandle)
        {
            ...
            retCode =
                AlazarAPI.AlazarInputControl(
                    ...
                    AlazarAPI.INPUT_RANGE_PM_1_V,	    // U32 -- input range id
            ...
            try
            {
                ...
                fixed (byte* pBuffer = buffer)
                {
                    ...
                    while (!done)
                    {
                        ...
                        // An 8-bit sample code occupies each 8-bit sample value in the record.
                        //
