...
namespace NPT_WaitNextBuffer
{
    ...
    // to make a Traditional AutoDMA acquisition. 
            ...
            try
            {
                ...
                fixed (short* pBuffer = byteToShortArray.shorts)
                {
                    ...
                    UInt32 admaFlags = AlazarAPI.ADMA_EXTERNAL_STARTCAPTURE |   // Start acquisition when we call AlazarStartCapture 
                                       AlazarAPI.ADMA_TRADITIONAL_MODE |	    // Acquire multiple records optionally with pretrigger samples and record headers
